package me.stefvanschie.buildinggame.commands.subcommands.settings.commands.second;
...
public class Remove extends ConsoleCommand {
	...
	public CommandResult onCommand(CommandSender sender, String[] args) {
		...
		config.set("commands.second", config.getStringList("commands.second").remove(command));
