package me.stefvanschie.buildinggame.commands.subcommands.settings.teamselection;
...
import me.stefvanschie.buildinggame.commands.subcommands.settings.teamselection.item.Id;
...
public class Item extends ConsoleCommand {
	...
	public String getPermission() {
		return "bg.setting.teamselection.item";
	}
}