package com.gmail.stefvanschiedev.buildinggame.commands.subcommands.settings.commands;
...
import com.gmail.stefvanschiedev.buildinggame.commands.subcommands.settings.commands.others.Add;
import com.gmail.stefvanschiedev.buildinggame.commands.subcommands.settings.commands.others.Remove;
...
public class Others extends ConsoleCommand {
	...
	public String getInfo() {
		return "Change the others command";
	}

	@Override
	public String getPermission() {
		return "bg.setting.commands.others";
	}
}