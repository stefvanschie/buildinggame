package com.gmail.stefvanschiedev.buildinggame.commands.subcommands.settings.blocks;
...
import com.gmail.stefvanschiedev.buildinggame.commands.subcommands.settings.blocks.blocked.Add;
import com.gmail.stefvanschiedev.buildinggame.commands.subcommands.settings.blocks.blocked.Remove;
import com.gmail.stefvanschiedev.buildinggame.managers.messages.MessageManager;

public class Blocked extends ConsoleCommand {
	...
	public String getInfo() {
		return "Edit the blocked blocks setting";
	}

	@Override
	public String getPermission() {
		return "bg.setting.blocks.blocked";
	}
}