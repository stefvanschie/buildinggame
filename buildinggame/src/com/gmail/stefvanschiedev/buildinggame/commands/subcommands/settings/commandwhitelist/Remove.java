...
public class Remove extends ConsoleCommand {
	...
	public CommandResult onCommand(CommandSender sender, String[] args) {
		...
		config.set("command-whitelist", config.getStringList("command-whitelist").remove(command.toString().trim()));
	...
	public String getInfo() {
		return "Remove a command from the whitelist";
	}

	@Override
	public String getPermission() {
		return "bg.setting.commandwhitelist.remove";
	}
}