...
public class Particle {
	...
	public void render() {
		if (getType() == ParticleType.ANGRY_VILLAGER)
			...
			if (data != null)
				location.getWorld().spawnParticle(org.bukkit.Particle.FALLING_DUST, location, 100, .5, .5, .5, data);
			else
			...
			location.getWorld().spawnParticle(org.bukkit.Particle.TOTEM, location, 100, .5, .5, .5);
