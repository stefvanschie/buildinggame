...
public class DevicesHeadsMenu extends Gui {
	...
	public DevicesHeadsMenu() {
		...
		addItem(goldenClock, new Action());
		...
		addItem(antiqueClock, new Action());
		...
		addItem(securityCamera, new Action());
		...
		addItem(ceilingLamp, new Action());
		...
		addItem(policeSiren, new Action());
		...
		addItem(policeSiren2, new Action());
		...
		addItem(c4Explosive, new Action());
