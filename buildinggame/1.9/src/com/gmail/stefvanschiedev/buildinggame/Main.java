...
public class Main extends JavaPlugin {
	...
	public void loadPlugin() {
		...
		if (!loadedListeners) {
			...
			Bukkit.getPluginManager().registerEvents(new DamageIndicatorClick(), this);
			Bukkit.getPluginManager().registerEvents(new DragonBreathClick(), this);
			Bukkit.getPluginManager().registerEvents(new EnchantmentClick(), this);
			Bukkit.getPluginManager().registerEvents(new EndRodClick(), this);
			...
			Bukkit.getPluginManager().registerEvents(new SweepAttackClick(), this);
