...
import com.gmail.stefvanschiedev.buildinggame.commands.subcommands.settings.commands.first.Add;
import com.gmail.stefvanschiedev.buildinggame.commands.subcommands.settings.commands.first.Remove;
...
public class First extends ConsoleCommand {
	...
	public String getInfo() {
		return "Change the first commands";
	}

	@Override
	public String getPermission() {
		return "bg.setting.commands.first";
	}
}