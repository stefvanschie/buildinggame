...
import com.gmail.stefvanschiedev.buildinggame.commands.subcommands.settings.commands.third.Add;
import com.gmail.stefvanschiedev.buildinggame.commands.subcommands.settings.commands.third.Remove;
...
public class Third extends ConsoleCommand {
	...
	public String getInfo() {
		return "Change the third commands";
	}

	@Override
	public String getPermission() {
		return "bg.setting.commands.third";
	}
}