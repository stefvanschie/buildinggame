...
public class ParticlesMenu {
	...
	public void show(Player player) {
		...
		Inventory inventory = Bukkit.createInventory(null, 27, messages.getString("gui.particles.title")
				.replace("%:a%", "ä")
				.replace("%:e%", "ë")
				.replace("%:i%", "ï")
				.replace("%:o%", "ö")
		...
		ItemStack damageIndicator = new ItemStack(Material.ANVIL, 1, (short) 2);
		{
			...
			{
				List<String> damageIndicatorLores = new ArrayList<String>();
				for (String lore : messages.getStringList("gui.particles.damage-indicator.lores"))
					damageIndicatorLores.add(MessageManager.translate(lore));
				damageIndicatorMeta.setLore(damageIndicatorLores);
			}
		...
		ItemStack dragonBreath = new ItemStack(Material.FIREBALL, 1);
		{
			...
			{
				List<String> dragonBreathLores = new ArrayList<String>();
				for (String lore : messages.getStringList("gui.particles.dragon-breath.lores"))
					dragonBreathLores.add(MessageManager.translate(lore));
				dragonBreathMeta.setLore(dragonBreathLores);
			}
		...
		ItemStack endRod = new ItemStack(Material.END_ROD, 1);
		{
			...
			{
				List<String> endRodLores = new ArrayList<String>();
				for (String lore : messages.getStringList("gui.particles.end-rod.lores"))
					endRodLores.add(MessageManager.translate(lore));
				endRodMeta.setLore(endRodLores);
			}
		...
		ItemStack sweepAttack = new ItemStack(Material.SHIELD, 1);
		{
			...
			{
				List<String> sweepAttackLores = new ArrayList<String>();
				for (String lore : messages.getStringList("gui.particles.sweep-attack.lores"))
					sweepAttackLores.add(MessageManager.translate(lore));
				sweepAttackMeta.setLore(sweepAttackLores);
			}
		...
		inventory.setItem(12, damageIndicator);
		inventory.setItem(13, dragonBreath);
		inventory.setItem(14, endRod);
		inventory.setItem(15, sweepAttack);
		inventory.setItem(16, fallingDust);
		
		inventory.setItem(25, clearParticles);
