...
public class BlocksHeadsMenuOne {
	...
	public void show(Player player) {
		...
		blueWoolMeta.setDisplayName(ChatColor.GOLD + "Blue Wool");
		...
		blackWoolMeta.setDisplayName(ChatColor.GOLD + "Black Wool");
		...
		woodPlankMeta.setDisplayName(ChatColor.GOLD + "Wood Plank");
		...
		podzolMeta.setDisplayName(ChatColor.GOLD + "Podzol");
		...
		grassMeta.setDisplayName(ChatColor.GOLD + "Grass");
		...
		snowGrassMeta.setDisplayName(ChatColor.GOLD + "Snow Grass");
		...
		dirtMeta.setDisplayName(ChatColor.GOLD + "Dirt");
		...
		mycelliumMeta.setDisplayName(ChatColor.GOLD + "Mycellium");
		...
		redSandMeta.setDisplayName(ChatColor.GOLD + "Red Sand");
		...
		sandMeta.setDisplayName(ChatColor.GOLD + "Sand");
		...
		soulsandMeta.setDisplayName(ChatColor.GOLD + "Soulsand");
		...
		netherrackMeta.setDisplayName(ChatColor.GOLD + "Netherrack");
		...
		mobSpawnerMeta.setDisplayName(ChatColor.GOLD + "Mob Spawner");
		...
		netherbrickMeta.setDisplayName(ChatColor.GOLD + "Netherbrick");
		...
		quartzOreMeta.setDisplayName(ChatColor.GOLD + "Quartz Ore");
		...
		enderpearlMeta.setDisplayName(ChatColor.GOLD + "Enderpearl");
		...
		endereyeMeta.setDisplayName(ChatColor.GOLD + "Endereye");
		...
		enderPortalMeta.setDisplayName(ChatColor.GOLD + "Ender Portal");
		...
		iceBlockMeta.setDisplayName(ChatColor.GOLD + "Ice Block");
		...
		waterMeta.setDisplayName(ChatColor.GOLD + "Water");
		...
		lavaMeta.setDisplayName(ChatColor.GOLD + "Lava");
		...
		emeraldBlockMeta.setDisplayName(ChatColor.GOLD + "Emerald Block");
		...
		diamondBlockMeta.setDisplayName(ChatColor.GOLD + "Diamond Block");
		...
		goldBlockMeta.setDisplayName(ChatColor.GOLD + "Gold Block");
		...
		ironBlockMeta.setDisplayName(ChatColor.GOLD + "Iron Block");
		...
		emeraldOreMeta.setDisplayName(ChatColor.GOLD + "Emerald Ore");
		...
		redstoneOreMeta.setDisplayName(ChatColor.GOLD + "Emerald Ore");
		...
		diamondOreMeta.setDisplayName(ChatColor.GOLD + "Diamond Ore");
		...
		ironOreMeta.setDisplayName(ChatColor.GOLD + "Iron Ore");
		...
		goldOreMeta.setDisplayName(ChatColor.GOLD + "Gold Ore");
		...
		cobblestoneMeta.setDisplayName(ChatColor.GOLD + "Cobblestone");
		...
		stoneMeta.setDisplayName(ChatColor.GOLD + "Stone");
		...
		stoneBrickMeta.setDisplayName(ChatColor.GOLD + "Stone Brick");
		...
		stoneBrick2Meta.setDisplayName(ChatColor.GOLD + "Stone Brick");
		...
		chimneyMeta.setDisplayName(ChatColor.GOLD + "Chimney");
		...
		bedrockMeta.setDisplayName(ChatColor.GOLD + "Bedrock");
		...
		quartzBlockMeta.setDisplayName(ChatColor.GOLD + "Quartz Block");
		...
		slimeBallMeta.setDisplayName(ChatColor.GOLD + "Slime Ball");
		...
		redstoneLampOnMeta.setDisplayName(ChatColor.GOLD + "Redstone Lamp (On)");
		...
		pistonMeta.setDisplayName(ChatColor.GOLD + "Piston");
		...
		stickyPistonMeta.setDisplayName(ChatColor.GOLD + "Sticky Piston");
		...
		slimePistonMeta.setDisplayName(ChatColor.GOLD + "Slime Piston");
		...
		halfPistonMeta.setDisplayName(ChatColor.GOLD + "Half Piston");
